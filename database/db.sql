...
INSERT IGNORE INTO `client_master` (`id`, `name`, `email`, `mobile_no`, `address`, `state`, `cities`) VALUES
	(190, 'priya', 'priyasingh78256@gmail.com', '7242309809', 'noida sector-15', '26', '2957'),
	(196, 'alok', 'a@gmail.com', '8613589698', 'asdf', '6', '594'),
	(199, 'Ayush', 'ayush.developer0925@gmail.com', '9315935071', 'shiv vihar', '38', '4932'),
	(208, 'dfjklhasdklf', 'asdfgsd@gmail.com', '9235431564', 'dfjklo', '2', '5'),
	(209, 'hello', 'hello@gmail.com', '9685968596', 'lajpat nagar', '10', '706');
...
CREATE TABLE IF NOT EXISTS `invoice_item_list` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`),
  KEY `invoice_item_list_ibfk_1` (`invoice_id`) USING BTREE,
  CONSTRAINT `FK_invoice_item_list_invoice_master` FOREIGN KEY (`invoice_id`) REFERENCES `invoice_master` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_invoice_item_list_item_master` FOREIGN KEY (`item_id`) REFERENCES `item_master` (`s_no`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=402 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT IGNORE INTO `invoice_item_list` (`id`, `invoice_id`, `item_id`, `price`, `quentity`, `total`) VALUES
	(369, 214, 45, 50800, 1, 50800),
	(370, 214, 57, 30, 1, 30),
	(371, 214, 48, 40, 1, 40),
	(372, 214, 43, 35000, 1, 35000),
	(398, 213, 57, 30, 1, 30),
	(399, 213, 48, 40, 1, 40),
	(400, 213, 48, 40, 1, 40),
	(401, 213, 45, 50800, 1, 50800);
...
CREATE TABLE IF NOT EXISTS `invoice_master` (
  ...
  KEY `invoice_master_ibfk_1` (`client_id`),
  CONSTRAINT `invoice_master_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `client_master` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT IGNORE INTO `invoice_master` (`id`, `client_id`, `created_date`, `total_amount`) VALUES
	(213, 199, '2023-12-07', 50910),
	(214, 190, '2023-12-11', 85870);
...
INSERT IGNORE INTO `item_master` (`s_no`, `item_name`, `item_description`, `item_price`, `item_file`) VALUES
	(42, 'cpu', 'cpu', '40000', 'repository-open-graph-template.png'),
	(43, 'cycle', 'cycle', '35000', 'customized_softwares.png'),
	(44, 'mobile', 'mobile', '15000', 'hosted_callcenter_solution.png'),
	(45, 'laptop', 'laptop', '50800', 'customized_softwares.png'),
	(46, 'computer', 'computer', '80500', 'hosted_callcenter_solution.png'),
	(47, 'mouse', 'mouse', '2000', 'customized_softwares.png'),
	(48, 'note book', 'note book', '40', 'hosted_telephony.png'),
	(57, 'pen', 'pen', '30', 'customized_softwares.png'),
	(58, 'keybord', 'keybord', '1200', 'hosted_telephony.png'),
	(59, 'ups', 'ups', '2500', 'customized_softwares.png');
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4122 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
BEGIN
    ...
    SELECT COUNT(id)  INTO @user_master FROM user_master;

    SELECT COUNT(id) INTO @client_master  FROM client_master;
 

    SELECT COUNT(s_no) INTO @item_master  FROM item_master;
    
    SELECT COUNT(id) INTO @invoice_master FROM invoice_master;

    SELECT @user_master AS user_master, @client_master AS client_master, @item_master AS item_master, @invoice_master AS invoice_master;
END//
DELIMITER ;
...
INSERT IGNORE INTO `user_master` (`id`, `name`, `email_id`, `mobile_no`, `PASSWORD`) VALUES
	(69, 'Ayush Garg', 'ayush.developer0925@gmail.com', '9315935071', '$2y$10$PfvUNrxAO6OPLu6Dk/2MietIWMAD9CO/JrgZM4U0LMYHImC9DuvcK'),
	(70, 'aman', 'a@gmail.com', '8618416358', '$2y$10$F0oi9H66gU627XwcXdFsPuZ1v32L7PmpXJi69RoalOvk8XwCXewF6'),
	(72, 'kushal', 'k@gmail.com', '9999999999', '$2y$10$otwCmtCmmnlj.zv97I5IGu8PpT5yE3RZoj2A7Hs1JW0nYAz5ouut.'),
	(75, 'amit', 'AMIT@sansoftwares.com', '9453456345', '$2y$10$kz41SNUT8yVl7ZVapUrujONgWPEjobLmGMvPYDMaEvA9fu3ho6PXa'),
	(76, 'Ayush Garg', 'aasd@gmail.com', '9524861468', '$2y$10$9Pq14KFFPHBj0FhLTiw4S.Ggcu./wQWLzNLf02aqeWGrzbM4ENdJu'),
	(77, 'Ayus', 'ritikgupta@sansoftwares.c.om', '9235456468', '$2y$10$5Pg19l5uSb3iDvUxMV25k.BmcvDPdRX54kcSb4eJGN.GZTV370Tx.');
