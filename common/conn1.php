...
class DbConnectivity1
{
    ...
    function num_rows($result){  
        $whiledata = mysqli_num_rows($result);
           return $whiledata;
    }
    function fetch_array($result){  
           $whiledata = mysqli_fetch_array($result, MYSQLI_ASSOC);
           return $whiledata;
    }
    function fetch_assoc($result){  
           $whiledata = mysqli_fetch_assoc($result);
           return $whiledata;
    }
    function json_true($S_code, $msg){
        echo json_encode(array('success' => true, 'statuscode' => $S_code, 'message' => $msg));
    }
